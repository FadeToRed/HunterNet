...
function hnDoRegister() {
  ...
  hnSaveCreds( onSaved, onErr);
  hnSaveProfiles( onSaved, onErr);
}
...
function hnSaveProfile() {
  ...
  hnSaveProfiles( onDone, function(){ hnShowErr('hn-edit-err','Errore nel salvataggio.'); });
  hnSaveCreds( onDone, function(){ hnShowErr('hn-edit-err','Errore nel salvataggio.'); });
}
...
function hnUpdatePresence() {
  ...
  hnSaveProfiles( function(){}, function(){});
}
