...
function hnFormatText(text) {
  ...
  t = t.replace(/\*\*([^*]+)\*\*/g,'<span class="hn-fmt-b">$1</span>');
  t = t.replace(/~~([^~]+)~~/g,'<span class="hn-fmt-s">$1</span>');
  t = t.replace(/__([^_]+)__/g,'<span class="hn-fmt-u">$1</span>');
  t = t.replace(/_([^_]+)_/g,'<span class="hn-fmt-i">$1</span>');
