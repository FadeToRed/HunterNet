...
function hnSubmitPost() {
  ...
  hnPUT(hn_api+'/'+hn_bin_post, {posts:hn_posts},
    function(){ ta.value=''; hnClearImg(); hnUpdateChar(); hnRenderFeed(); hnRenderSidebar(); btn.disabled=false; btn.textContent='Pubblica'; hnNotifMentions(text, post.id, text); },
