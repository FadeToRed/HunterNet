...
function hnOpenProfile(aid) {
  ...
  document.getElementById('hn-profcontent').innerHTML=
    ...
    '<div class="hn-profinfo"><h2>'+hnEsc(prof.name)+'</h2><div class="hn-profhandle">@'+hnEsc(prof.handle)+'</div>'+
...
function hnRenderNotifDrop() {
  ...
  if (!mine.length) {
    ...
    for (var j = 0; j < mine.length; j++) {
      ...
      html += '<div class="hn-notif-item' + unread + '" onclick="hnNotifClick(\'' + n.id + '\',\'' + (n.post_id||'') + '\',\'' + (n.from_id||'') + '\')">' +
